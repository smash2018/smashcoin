...
namespace Checkpoints
{
    ...
    // smashcoin: synchronized checkpoint (centrally broadcasted)
    ...
    // smashcoin: get last synchronized checkpoint
    ...
    // smashcoin: only descendant of current sync-checkpoint is allowed
    ...
    // smashcoin: reset synchronized checkpoint to last hardened checkpoint
...
// smashcoin: sync-checkpoint master key
...
// smashcoin: verify signature of sync-checkpoint message
...
// smashcoin: process synchronized checkpoint
