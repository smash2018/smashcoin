...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(BitcoinUnits::smash)
    {
    ...
    txdelegate(new TxViewDelegate())
{
    ...
    ui->label->setFont(QFont("Monospace", 12, -1));
    ui->label_6->setFont(QFont("Monospace", 12, -1));
    ui->label_3->setFont(QFont("Monospace", 12, -1));
    ui->label_2->setFont(QFont("Monospace", 12, -1));

    // Balance: <balance>
    ui->labelBalance->setFont(QFont("Monospace", 12, QFont::Bold));
    ...
    // smashcoin: stake: <stake>
    ui->labelStake->setFont(QFont("Monospace", 12, QFont::Bold));
    ...
    ui->labelUnconfirmed->setFont(QFont("Monospace", 12, QFont::Bold));
    ...
    ui->labelNumTransactions->setFont(QFont("Monospace", 12, QFont::Bold));
