...
// SmashCoin message start (switch from PeerCoin's in v0.4)
static unsigned char pchMessageStartBitcoin[4] = { 0xf9, 0xbe, 0xb4, 0xd9 };
// 20160920 PCW Mod
static unsigned char pchMessageStartSmashCoin[4] = { 0x73, 0x6D, 0x73, 0x68 };
// 20160920 PCW Mod
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartSmashCoin : pchMessageStartBitcoin, sizeof(pchMessageStartSmashCoin));
}
